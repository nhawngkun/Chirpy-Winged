...
public class UIManager_ChirpyWinged : Singleton_ChirpyWinged<UIManager_ChirpyWinged>
{
    [SerializeField] private List<UICanvas_ChirpyWinged> uiCanvases;
    ...
    void Start()
    {
        UIManager_ChirpyWinged.Instance.OpenUI<UIhome_ChirpyWinged>();
    }

    private UICanvas_ChirpyWinged GetUICanvasFromCanvasGroup(CanvasGroup cg)
    {
        if (cg == null) return null;
        return cg.GetComponent<UICanvas_ChirpyWinged>();
    }
    ...
    public void EnablePasue(bool enable)
    {
        if (enable)
        {
            UICanvas_ChirpyWinged canvas = GetUICanvasFromCanvasGroup(gamepasue);
    ...
    public void EnableLoss(bool enable)
    {
        if (enable)
        {
            UICanvas_ChirpyWinged canvas = GetUICanvasFromCanvasGroup(Loss);
            if (canvas != null) canvas.Setup();
    ...
    public void EnableHowToPlay(bool enable)
    {
        if (enable)
        {
            UICanvas_ChirpyWinged canvas = GetUICanvasFromCanvasGroup(howToPlay);
            if (canvas != null) canvas.Setup();
    ...
    public void EnableHome(bool enable)
    {
        if (enable)
        {
            UICanvas_ChirpyWinged canvas = GetUICanvasFromCanvasGroup(home);
            if (canvas != null) canvas.Setup();
    ...
    public void EnableWin(bool enable)
    {
        if (enable)
        {
            UICanvas_ChirpyWinged canvas = GetUICanvasFromCanvasGroup(winPopUp);
            if (canvas != null)
            {
                canvas.Setup();
                canvas.Open();
    ...
    public void EnableSettingPanel(bool enable)
    {
        if (enable)
        {
            UICanvas_ChirpyWinged canvas = GetUICanvasFromCanvasGroup(settingPanel);
            if (canvas != null) canvas.Setup();
    ...
    public void EnableGameplay(bool enable)
    {
        if (enable)
        {
            UICanvas_ChirpyWinged canvas = GetUICanvasFromCanvasGroup(gamplayPanel);
            if (canvas != null)
            {
                canvas.Setup();
                canvas.Open();
    ...
    public void EnableLevelPanel(bool enable)
    {
        if (enable)
        {
            UICanvas_ChirpyWinged canvas = GetUICanvasFromCanvasGroup(levelPanel);
            if (canvas != null)
            {
                canvas.Setup();
                canvas.Open();
    ...
    public void EnableShop(bool enable)
    {
        if (enable)
        {
            UICanvas_ChirpyWinged canvas = GetUICanvasFromCanvasGroup(shopPanel);
            if (canvas != null) canvas.Setup();
    ...
    public T OpenUI<T>() where T : UICanvas_ChirpyWinged
    {
        T canvas = GetUI<T>();
        if (canvas != null)
        {
    ...
    public void CloseUI<T>(float time) where T : UICanvas_ChirpyWinged
    {
        T canvas = GetUI<T>();
        if (canvas != null)
        {
    ...
    public void CloseUIDirectly<T>() where T : UICanvas_ChirpyWinged
    {
        T canvas = GetUI<T>();
        if (canvas != null)
        {
    ...
    public bool IsUIOpened<T>() where T : UICanvas_ChirpyWinged
    {
        T canvas = GetUI<T>();
    ...
    public T GetUI<T>() where T : UICanvas_ChirpyWinged
    {
